 ...
 */
/**
 * 달리기반 문제 33 번 체육복 / 걷기반 문제 49번 체육복과 동일
 */
import java.util.Arrays;
class RunSolution33 {
    public int runSolution33(int n, int[] lost, int[] reserve) {
        int answer = 0;
    ...
    public static void main(String[] args) {
        RunSolution33 runSolution33 = new RunSolution33();

        int n = 5;
        int[] lost = {2, 4};
        int[] reserve = {1,3,5};
        System.out.println(runSolution33.runSolution33(n,lost,reserve));
    }
}
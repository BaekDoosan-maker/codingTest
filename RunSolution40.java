 ...
 * 매개변수로 주어질 때, 크레인을 모두 작동시킨 후 터트려져 사라진 인형의 개수를 return 하도록
 * solution 함수를 완성해주세요.
 *
 * [제한사항]
...
class RunSolution40 {
    public int runSolution40(int[][] board, int[] moves) {
        // 1. 연속된 인형들이 제거된 횟수.
        int answer = 0;
        // 2. 인형을 담을 stack 바구니.
    ...
    public static void main(String[] args) {
        RunSolution40 runSolution40 = new RunSolution40();
        int [][]board = {{0,0,0,0,0},{0,0,1,0,3},{0,2,5,0,1},{4,2,4,4,2},{3,5,1,3,1}};
        int []moves = {1,5,3,5,1,2,1,4};
        System.out.println(runSolution40.runSolution40(board , moves));
    }
}
...
class RunSolution36{
    ...
    public String runSolution36(int[] numbers, String hand) {
    ...
    public static void main(String[] args) {
        RunSolution36 runSolution36 = new RunSolution36();
        int numbers [] = {1, 3, 4, 5, 8, 2, 1, 4, 5, 9, 5};
        String stringhand = "right";
        System.out.println(runSolution36.runSolution36(numbers,stringhand));
    }
}